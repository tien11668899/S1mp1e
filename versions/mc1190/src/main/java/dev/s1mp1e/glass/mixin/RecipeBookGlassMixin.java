...
/**
 * System 2 (recipe book glass) — the 1.19.2 Fabric port of LiquidGlass26's
...
public abstract class RecipeBookGlassMixin {
    ...
    private void s1mp1e$glassBook(RecipeBookWidget self, MatrixStack matrices,
    ...
    private void s1mp1e$drawTabBar(float fade) {
        ...
        for (RecipeGroupButtonWidget t : tabs) {
            ...
            maxY = Math.max(maxY, t.y + t.getHeight());
            tabH = t.getHeight();
        }
        if (visible == 0) return;
