...
public final class PotionHudModule extends Module implements HudBounds, HudRenderer {
    ...
    private static final Map<RegistryEntry<StatusEffect>, int[]> CACHE = new HashMap<RegistryEntry<StatusEffect>, int[]>();
    ...
    private static int[] contour(RegistryEntry<StatusEffect> type, Sprite sprite) {
    ...
    private static int color(RegistryEntry<StatusEffect> type) {
    ...
    private static final Comparator<StatusEffectInstance> NAME_ORDER = new Comparator<StatusEffectInstance>() {
        public int compare(StatusEffectInstance a, StatusEffectInstance b) {
            return a.getEffectType().value().getName().getString()
                    .compareTo(b.getEffectType().value().getName().getString());
        }
    };
}
