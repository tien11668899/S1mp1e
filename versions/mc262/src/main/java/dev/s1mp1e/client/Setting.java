...
public final class Setting {
    ...
    /** When true, the setting still persists (saved/loaded by name) but is NOT shown as a row in the
     *  config detail list — used for values edited elsewhere (e.g. per-key Keystrokes positions set by
     *  the HUD editor). Set via {@link #hide()}. */
    ...
    /** Marks this setting {@link #hidden} and returns it, for chaining in a field initialiser. */
    public Setting hide() { this.hidden = true; return this; }
