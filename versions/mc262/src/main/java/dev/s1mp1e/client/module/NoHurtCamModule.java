 ...
 * Mixin-driven on 26.2 — {@code GameRendererHurtTiltMixin} cancels {@code GameRenderer.bobHurt},
 * {@code LivingEntityRendererFlashMixin} drops the red overlay row in
 * {@code LivingEntityRenderer.getOverlayCoords}. Each is gated by its own setting via the static
 * accessors below (INSTANCE pattern like CpsModule).
 */
