 ...
 * the render matrix in {@code ItemInHandRenderer.submitArmWithItem} (26.2 name of 1.21.1's
 * {@code HeldItemRenderer.renderFirstPersonItem}); it never changes hit registration, reach or
