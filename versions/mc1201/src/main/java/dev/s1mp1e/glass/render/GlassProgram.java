...
public final class GlassProgram {
    ...
    public static void bind(int kind) {
        ...
        // 1.20.1: getModelViewStack() returns the Mojang MatrixStack (NOT the JOML
        // Matrix4fStack of 1.20.2+/1.21), so reach the current matrix via peek().
        setMat(uModelView[kind], RenderSystem.getModelViewStack().peek().getPositionMatrix());
