...
public abstract class Widget {
    ...
    public abstract void draw(DrawContext g, int mouseX, int mouseY, float delta, float alpha);
    public void drawOverlay(DrawContext g, int mouseX, int mouseY, float alpha) {}
