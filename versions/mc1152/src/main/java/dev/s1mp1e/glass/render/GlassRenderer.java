...
public final class GlassRenderer {
    ...
    public static void endBatch() {
        ...
        // Defensive: batchQuad sets the vertex colour with RAW GL11.glColor4f, which
        // RenderSystem's colour cache never sees; if RenderSystem.color4f no-ops on a
        // stale-white cache the real GL colour would stay at the last quad's value
        // (the lattice's empty-corner cell ends on alpha 0), multiplying every vanilla
        // draw after the glass to invisible. Force the real GL colour white too. (1.14.4
        // hit exactly this via GlStateManager; 1.15.2 can't be visually verified here.)
